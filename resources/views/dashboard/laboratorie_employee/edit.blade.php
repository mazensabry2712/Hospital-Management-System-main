<!-- Modal -->
<div class="modal fade" id="edit{{ $laboratorie_employee->id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('laboratorie_employee.update', $laboratorie_employee->id) }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" value="{{ $laboratorie_employee->name }}" name="name"
                        class="form-control"><br>

                    <label for="exampleInputPassword1">البريد الالكتروني</label>
                    <input type="email" value="{{ $laboratorie_employee->email }}" name="email"
                        class="form-control"><br>
                </div>
