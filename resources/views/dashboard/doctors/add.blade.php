    ...
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"> {{ trans('dashboard/doctors.doctors') }}</h4><span
                ...
                {{ trans('dashboard/doctors.add_doctors') }}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                ...
                <form action="{{ route('doctors.store') }}" method="post" autocomplete="off"
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-200">
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            <div class="col-md-1">
                                <label for="exampleInputEmail1">
                                    {{ trans('dashboard/doctors.password_confirmation') }}</label>
                            </div>
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                ...
                                <img style="border-radius:20%" width="150px" height="150px" id="output" />
                            </div>
                        </div>
