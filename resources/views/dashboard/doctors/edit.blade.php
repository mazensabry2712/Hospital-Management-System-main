...
@section('title')
    {{ trans('dashboard/doctors.edit_doctors') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"> {{ trans('dashboard/doctors.doctors') }}</h4><span
                class="text-muted mt-1 tx-13 mr-2 mb-0">/
                {{ trans('dashboard/doctors.edit_doctors') }}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-200">
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-1">
                                <label for="exampleInputEmail1">
                                    {{ trans('dashboard/doctors.doctor_image') }}</label>
                            </div>
                                ...
                                <div>
                                    @if ($doctor->image)
                                        <img style="border-radius:20%"
                                            ...
                                            alt="{{ trans('dashboard/doctors.image_not_found') }}" id="output" />
                                    @else
                                        <img style="border-radius:50%"
                                            src="{{ Url::asset('dashboard/img/doctors/default.png') }}" height="50px"
                                            width="50px" alt="">
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                ...
                                <input class="form-control" name="id" type="hidden" value="{{ $doctor->id }}">
                            </div>
                        </div>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            <div class="col-md-1">
                                <label for="exampleInputEmail1">
                                    {{ trans('dashboard/doctors.doctor_phone') }}</label>
                            </div>
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            <div class="col-md-1">
                                <label for="exampleInputEmail1">
                                    {{ trans('dashboard/doctors.doctor_appointments') }}</label>
                            </div>

                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                <select multiple="multiple" name="appointments[]" class="form-control SlectBox">
                                    ...
                                    @foreach ($appointments as $appointment)
                                        <option value="{{ $appointment->id }}"
                                            {{ in_array($appointment->id, $doctorAppointments) ? 'selected' : '' }}>
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            <div class="col-md-1">
                                <label for="exampleInputEmail1">
                                    {{ trans('dashboard/doctors.doctor_section_name') }}</label>
                            </div>
