    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" href="{{ route('dashboard.admin') }}"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                </svg><span class="side-menu__label">{{ trans('dashboard\main_sidebar.index') }}</a>
        </li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('dashboard\main_sidebar.sections') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('sections.index') }}">{{ trans('dashboard\main_sidebar.view_all') }}</a>
                </li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('dashboard/main_sidebar.doctors') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('doctors.index') }}">{{ trans('dashboard/main_sidebar.view_all') }}</a>
                </li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('dashboard/main_sidebar.Service') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('services.index') }}">{{ trans('dashboard/main_sidebar.Single_service') }}</a>
                </li>
                <li><a class="slide-item"
                        href="{{ route('Add_GroupServices') }}">{{ trans('dashboard/main_sidebar.group_services') }}</a>
                </li>
                <li><a class="slide-item"
                        href="{{ route('insurances.index') }}">{{ trans('dashboard/main_sidebar.Insurance') }}</a>
                </li>
                <li><a class="slide-item"
                        href="{{ route('ambulances.index') }}">{{ trans('dashboard/main_sidebar.ambulance') }}</a>
                </li>
                <li><a class="slide-item" href="#">{{ trans('dashboard/main_sidebar.Ambulance_calls') }}</a>
                </li>
            </ul>
        </li>
        <li class="slide">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a class="slide-item" href="#">قائمة الكشوفات</a></li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a class="slide-item" href="#">قائمة المواعيد المؤكدة</a>
                </li>
                <li><a class="slide-item" href="{{ url('/' . ($page = 'map-vector')) }}">قائمة المواعيد
                        المنتهية</a>
                </li>
            </ul>
        </li>
