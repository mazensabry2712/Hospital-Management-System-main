...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المرضي</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اضافة مريض
                    جديد</span>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('patients.store') }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label>العنوان</label>
                                <textarea rows="3" cols="10" class="form-control" name="address"></textarea>
                            </div>
